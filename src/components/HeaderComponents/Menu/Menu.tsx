    ...
    return (
        <div className="w-[40px] h-[40px] relative" ref={menuRef}>
            <button
                ...
                ${menu ? 'after:-rotate-45 after:translate-y-0 before:rotate-45 before:translate-y-0' : 'after:translate-y-2 before:-translate-y-2'}`}
            >
            </button>
            <div
                className={`w-[25px] h-[1.6px] absolute top-[50%] -translate-y-[50%] left-[50%] -translate-x-[50%] bg-blackPage transition-all duration-[1s] 
