    ...
    <div className="max-w-[1200px] mx-auto mt-[100px] sm:mt-[110px] md:mt-[115px] lg:mt-[115px] xl:mt-[115px] bg-white font-poppins">
      ...
      <div className="flex flex-col items-center gap-[50px] mb-[40px] sm:mb-[60px] md:mb-[80px] lg:mb-[80px] xl:mb-[80px] sm:flex-row md:flex-row lg:flex-row xl:flex-row sm:justify-center md:justify-center lg:justify-center xl:justify-center">
        ...
        <div className="flex flex-col relative">
          <img src={language?.country_photo_url} alt="languageImage" className="w-[269px] h-[236px] flex-shrink-0 rounded-[20px] ml-[61px] md:w-[300px] lg:w-[345px] xl:w-[433px] md:h-[280px] lg:h-[280px] xl:h-[280px]" />
          <img src={language?.flag_url} alt="languageFlag" className="w-[122px] h-[70px] absolute bottom-[-35px] left-0 flex-shrink-0" />
        </div>
      ...
      <div className="flex flex-col items-center gap-[40px] text-black mb-[40px]">
        ...
        <h2 className="font-bold text-[15px] sm:text-[18px] md:text-[23px] lg:text-[25px] xl:text-[25px]">¿Por qué te gustaria estudiar {language?.name}?</h2>
