        ...
        <div className="flex flex-col self-center gap-[25px] shadow-md shadow-gray p-[3px] w-full sm:w-[80%] md:w-[80%] lg:w-[75%] xl:w-[60%] lg:ml-[15px]">
          ...
          >
            <Form className="flex flex-col gap-[20px] sm:gap-[35px] md:gap-[50px] justify-center items-center">
              ...
              <button
                type="submit"
                className="w-[250px] h-[40px] bg-violet text-whitePage font-bold transition-all hover:bg-violetHover justify-center"
                onClick={() => alert("Método de pago no disponible")}
              >
                Confirmar Suscripción
              </button>
            </Form>
          ...
          <div className="flex items-center ml-[5px] md:ml-[10px]">
            <label className="flex items-center cursor-pointer gap-[3px]">
              ...
              ></span>
              <span className="text-[11px] font-bold sm:text-[13px] md:text-[16px]">
                Desea guardar los datos de la tarjeta para el futuro??
              </span>
            </label>
          </div>
          <div className="flex flex-col gap-[20px] justify-center items-center mb-[20px]">
            ...
            <button
              type="submit"
              className="w-[250px] h-[40px] bg-green text-whitePage 
